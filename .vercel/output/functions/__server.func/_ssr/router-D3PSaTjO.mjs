...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D3PSaTjO.js
var router_D3PSaTjO_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Ba2hPRbX.css";
var APP_NAME = "For My Coolest Baby";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A little birthday website, made with love. August 26. For my coolest baby."
			},
			{
				name: "theme-color",
				content: "#f7f1ea"
...
var $$splitComponentImporter = () => import("./routes-DhZKodjL.mjs");
...
//#endregion
export { getRouter, router_D3PSaTjO_exports as t };
